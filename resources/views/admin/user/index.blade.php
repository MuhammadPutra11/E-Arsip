   ...
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      <div class="grid gap-4 mb-4">
         <div class="flex">
            ...
            <form action="/foto" class="w-80 mx-10">   
       ...
       <tbody>
        @foreach ($foto as $foto)
           <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
               ...
               <th scope="row" class="max-w-20 max-h-20 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                   <img src="{{ asset('storage/' . $foto->file_foto) }}"></img>
               </th>
               ...
               <td class="px-6 py-4 flex">
                  <a href="{{ route('foto.download', $foto->id) }}" class="font-medium p-1.5 rounded-md text-black bg-green-500 dark:text-blue-500 hover:underline">Download</a>
                  <a href="/foto/{{ $foto->id }}/edit" class="font-medium p-1.5 rounded-md text-black bg-blue-500 dark:text-blue-500 hover:underline">Edit</a>
